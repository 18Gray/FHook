package com.eighteengray.nativehook;
...
public class HookActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			method = HookActivity.class.getDeclaredMethod("getApplicationContext");
		...
		try {
			...
			method = HookActivity.class.getDeclaredMethod("getString", int.class, String.class);
			HookUtils.hookMethod(method, "(ILjava/lang/String;)Ljava/lang/String;");
		...
		try {
			method = HookActivity.class.getDeclaredMethod("getString2", String[].class);
		...
		try {
			method = HookActivity.class.getDeclaredMethod("getString3", MyEntity.class);
			HookUtils.hookMethod(method, "(Lcom/example/allhookinone/HookActivity$MyEntity;)Ljava/lang/String;");
		} catch (NoSuchMethodException e) {
			e.printStackTrace();
		}
