...
extern "C" jint Java_com_eighteengray_nativehook_HookUtils_hookMethodNative(JNIEnv *env, jobject thiz, jstring cls, jstring methodname, jstring methodsig, jboolean isstatic){
...
extern "C" jint Java_com_eighteengray_nativehook_HookUtils_elfhook(JNIEnv *env, jobject thiz){
